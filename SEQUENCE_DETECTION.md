...
تم إضافة نظام احترافي لمراقبة تسلسل الآيات أثناء التسميع، يكتشف القفز أو الخلط في ترتيب الآيات دون محاولة تصحيح التجويد أو الحركات.
...
إضافة إعدادات جديدة قابلة للضبط:
